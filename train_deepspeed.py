...
def train(hyp,  # path/to/hyp.yaml or hyp dictionary
    ...
    # Model
    pretrained = weights.endswith('.pt')#yolov5s.pt
    if pretrained:
        with torch_distributed_zero_first(RANK):
    ...
    model, optimizer, _, _ = deepspeed.initialize(args=args, model=model , model_parameters=model.parameters(), optimizer=optimizer)
